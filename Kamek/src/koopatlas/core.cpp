...
bool WMInit_LoadSIAnims(void *ptr) {
	...
	DVD_LoadFile(GetDVDClass(), "Maps", "SI_boomerang", 0);
	DVD_LoadFile(GetDVDClass(), "Maps", "SI_spike", 0);
	DVD_LoadFile(GetDVDClass(), "Maps", "SI_bobomb", 0);
	DVD_LoadFile(GetDVDClass(), "Maps", "SI_frog", 0);
	DVD_LoadFile(GetDVDClass(), "Maps", "SI_thunder", 0);
	DVD_LoadFile(GetDVDClass(), "Maps", "SI_cloud", 0);
...
int dScKoopatlas_c::onDelete() {
	...
	DVD_FreeFile(GetDVDClass2(), "SI_boomerang");
	DVD_FreeFile(GetDVDClass2(), "SI_spike");
	DVD_FreeFile(GetDVDClass2(), "SI_bobomb");
	DVD_FreeFile(GetDVDClass2(), "SI_frog");
	DVD_FreeFile(GetDVDClass2(), "SI_thunder");
	DVD_FreeFile(GetDVDClass2(), "SI_cloud");
...
void dScKoopatlas_c::startLevel(dLevelInfo_c::entry_s *entry) {
	...
	globalPropeller = 0;
	globalFireShoot = 0;
	dGameDisplay_c::instance->purplecoins = 0;
